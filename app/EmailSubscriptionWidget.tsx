...
const EmailSubscriptionWidget = () => {
	...
	return (
		<div className="flex flex-col gap-y-4 md:gap-y-6">
			<form
				method="POST"
				onSubmit={submitSubscriberEmail}
				className="flex flex-col md:flex-row flex-wrap max-w-sm gap-4"
			>
				{(() => {
						...
						case 0:
							return (
								<>
									...
									<button
										type="submit"
										className="flex flex-1 min-w-8 basis-8 p-3 justify-center items-center bg-black text-white rounded-md font-bold"
									>
										Sign up
									</button>
								</>
						...
						case 200:
							return (
								<>
									...
									<span>
										Thank you! Check your email to confirm your
										subscription
									</span>
								</>
							);
						case 500:
							return (
								<>
									...
									<span>
										This email address appears to be invalid. Please
										check it and press the button to submit again
									</span>
								</>
							);
					}
